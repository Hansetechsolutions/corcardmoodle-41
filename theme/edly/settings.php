...
if ($ADMIN->fulltree) {
    ...
    */
    $page = new admin_settingpage('theme_edly_header', get_string('header_settings', 'theme_edly'));
        ...
        // Left Button Text
        $setting = new admin_setting_configtext('theme_edly/header_left_btn_text', get_string('header_left_btn_text','theme_edly'), get_string('header_left_btn_text_desc', 'theme_edly'), 'Get Started', PARAM_NOTAGS, 50);
        $setting->set_updatedcallback('theme_reset_all_caches');
        $page->add($setting);
